...
function Footer() {
  return (
    ...
    <div class="footer">
      ...
      <h5> <strong>91-811-889-9048</strong></h5>
      ...
      <div class="lang-select footer-lang-select">
        ...
        <label for="lang-2" class="lang-select">
          ...
          <div class="lang-svg caret-down-svg">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" data-name="CaretDown" aria-hidden="true">
