...
export default function DashMovie() {
  ...
  const handleDelete = (rowId) => {
    ...
    data.rowId=rowId
      ...
      axios.post("/api/v1/admin/deleteMovie", data )
      .then(response => {
  ...
  return (
    <>
     <div className="mb-6 border-b pb-4 ">
        <h1 className="text-2xl font-semibold text-white ml-3">MOVIE SECTION</h1>
      </div>
    <div className=" text-right mr-36 mb-5 ">
        ...
        <button onClick={() => navigate("/dashbord/movies/uploadmovie")} className='bg-white p-2 font-bold rounded-xl hover:bg-red-700 hover:text-white m-2'>Add Movie</button>    </div>
    <Table
    headers={['ID','Movie Name', 'Genres', 'Reatin']}
    data={movieData || []}
